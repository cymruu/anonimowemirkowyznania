import { Dialog, DialogActions, DialogContent, DialogTitle, Button, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, TextField, Snackbar } from "@material-ui/core";
import React, { useState, SyntheticEvent, Fragment } from "react";
import { buttonActionFunction } from "./ActionButtons";

export function ConfessionDeclineDialog(
  ...
  return (
        <Fragment>
          ...
          <Dialog
          open={open}
          onClose={e=>setDeclineDialogOpen(false)}
        >
          ...
          <DialogActions>
            <Button onClick={e=>setDeclineDialogOpen(false)} color="primary">
              Close
            </Button>
